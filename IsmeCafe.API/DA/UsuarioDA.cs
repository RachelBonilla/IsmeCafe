    ...
    public class UsuarioDA : IUsuarioDA
    {
        ...
        public async Task<Guid> AgregarCliente(UsuarioClienteRequest usuario)
        {
            ...
            var resultadoConsulta = await _sqlConnection.ExecuteScalarAsync<Guid>(query, new
            {
                ...
                Telefono = usuario.Telefono,
                Contrasena = usuario.Contrasena,
                SuscritoMarketing = usuario.SuscritoMarketing
            });
        ...
        public async Task<IEnumerable<string>> ObtenerCorreosSuscritosMarketing()
        {
            string query = @"ObtenerCorreosSuscritosMarketing";
            return await _sqlConnection.QueryAsync<string>(query);
        }
